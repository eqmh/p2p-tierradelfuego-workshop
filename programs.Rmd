...
-   [**Protocolos de muestreo**](https://marinebon.github.io/p2p/methods_field_protocols.html) de biodiversidad del litoral rocoso con foto-cuadrantes
...
- Análisis de fotografías digitales con IA tomadas durante la capacitación
...
-   Presentación invitada: La Red de Observación Marina Argentina (ROMA) - Dr. Gustavo Ferreyra (Director del CADIC-CONICET)
...
## [**Protocolo de muestreo de biodiversidad marina con foto-cuadrantes**](https://marinebon.github.io/p2p/methods_field_protocols.html)
<br>
<br>
```{r}
library(tidyverse)
...
pts <- tribble(
  ...
  -68.219527, -54.80648, "Playa Larga", "child", "orange", "Playa Larga", NA) %>%
